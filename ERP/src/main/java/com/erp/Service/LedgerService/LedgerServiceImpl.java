...
import com.erp.Service.LedgerService.LedgerServiceNotification.LedgerServiceNotification;
...
public class LedgerServiceImpl implements LedgerService {
    ...
    private final LedgerServiceNotification ledgerServiceNotification;
    ...
    public LedgerResponse createLedger(LedgerRequest ledgerRequest) {
        ...
        ledgerServiceNotification.notifyLedgerCreated(ledger);
    ...
    public LedgerResponse updateLedgerInfo(LedgerRequest ledgerRequest) {
        ...
        ledgerServiceNotification.notifyLedgerUpdated(ledger);
    ...
    public LedgerResponse deleteByLedgerId(LedgerRequest ledgerId) {
        ...
        ledgerServiceNotification.notifyLedgerDeleted(ledger);
